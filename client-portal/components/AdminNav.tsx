    ...
    <header className="bg-[#1a1a2e] px-6 py-3 flex items-center justify-between shrink-0">
      <div className="flex items-center gap-6">
        ...
        <nav className="flex items-center gap-1">
          <Link href="/admin"
            className={`px-3 py-1.5 rounded-lg text-sm transition ${pathname === "/admin" ? "bg-white/15 text-white" : "text-white/60 hover:text-white hover:bg-white/10"}`}>
            Dashboard
          </Link>
        </nav>
      </div>
      <div className="flex items-center gap-3">
        <Link href="/admin/settings" title="Settings"
          className={`p-2 rounded-lg transition ${pathname === "/admin/settings" ? "bg-white/15 text-white" : "text-white/60 hover:text-white hover:bg-white/10"}`}>
