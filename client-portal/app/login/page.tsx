...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-[0.92fr_1.08fr] bg-paper">
      {/* Brand panel */}
      <div className="hidden md:flex relative flex-col justify-between overflow-hidden bg-primary px-12 py-10 text-white">
        <div
          aria-hidden="true"
          className="absolute -top-[6%] -right-[10%] w-[80%] h-[68%] opacity-30"
          style={{
        ...
        <div
          aria-hidden="true"
          className="absolute -bottom-[3%] -right-[5%] w-[44%] h-[38%] opacity-20"
          style={{
        ...
        <img src="/logo-light.svg" alt="Sympl Finance" className="relative z-10 h-11 w-auto" />
      ...
      <div className="flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <img src="/logo.svg" alt="Sympl Finance" className="h-11 w-auto mb-6 md:hidden" />
            <p className="kicker text-xs font-bold tracking-[0.18em] uppercase text-primary mb-2">Client Portal</p>
            <h2 className="text-2xl font-extrabold tracking-tight text-foreground">Welcome back.</h2>
          </div>

          <div className="w-full bg-white rounded-2xl shadow-[0_16px_34px_rgba(0,34,54,0.1)] border border-black/[0.06] p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-lg border border-black/10 text-sm focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-primary text-white py-2.5 rounded-full text-sm font-semibold hover:bg-primary-hover disabled:opacity-60 disabled:cursor-not-allowed transition mt-2"
              >
                {loading ? (
