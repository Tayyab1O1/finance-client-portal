...
import { getClient, updateClientProfile, getPortalSettings } from "@/lib/firestore";
...
export default function EditClientPage() {
  ...
  useEffect(() => {
    Promise.all([getClient(clientId), getPortalSettings()]).then(([c, settings]) => {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (logoFile) {
        updates.logoImageUrl = await uploadImage(logoFile, `clients/${clientId}/logo`);
      }
      if (coverFile) {
        updates.coverImageUrl = await uploadImage(coverFile, `clients/${clientId}/cover`);
      }
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-8 py-8 max-w-3xl">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
          <Link href="/dashboard" className="hover:text-[#1a1a2e] transition">Dashboard</Link>
          <span>/</span>
        ...
        <div className="space-y-5">
          ...
          <section className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">PNG, JPG up to 2MB. Shown next to client name.</p>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1.5">Shown as the banner background in the client portal.</p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-wide">Services Availed</h2>
            </div>
          ...
          <div className="flex items-center justify-between pt-2 pb-8">
            <Link href="/dashboard" className="text-sm text-gray-500 hover:text-[#1a1a2e] transition">
              ← Back to dashboard
            </Link>
